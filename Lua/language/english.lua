...
language.GhostRoleAvailable = "[Ghost Role] New ghost role available: %s (use ‖color:gui.orange‖!ghostrole‖color:end‖ to open the ghost role menu, or ‖color:gui.orange‖!ghostrole %s‖color:end‖ to accept it instantly)"
...
language.GhostRolesReminder = "Ghost roles available: %s\n\nUse ‖color:gui.orange‖!ghostrole‖color:end‖ to open the menu, or ‖color:gui.orange‖!ghostrole name‖color:end‖ to pick a role directly."
...
language.GameVoteNoHideMap = "Failed to find a map for Hide and Seek."
language.GameVoteSelectedHide = "Selected mode: Hide and Seek. Map: %s (%s slots)."
