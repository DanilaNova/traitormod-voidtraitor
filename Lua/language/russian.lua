...
language.Pointshop = {
    ...
    teamRed = "Команда красные",
    teamBlue = "Команда синие",
    teamRedDB = "Команда красные",
    teamBlueDB = "Команда синие",
    teamRedWatter = "Команда красные",
    teamBlueWatter = "Команда синие",
	...
	scout = "Скаут - с дубинкой и ппшками",
	soldier1 = "Солдат - c пистолетом-пулеметом",
	soldier2 = "Солдат - с дробовиком",
	assault1 = "Штурмовик - с штурмовой винтовкой",
	assault2 = "Штурмовик - c гремелкой и электровинтовкой",
	sniper1 = "Снайпер - c ружьем и 30мл гранатами",
	sniper2 = "Снайпер - c винчестером и ревиком",
	medic1 = "Медик - с медециной всей россии",
	clown1 = "Клоун - с молотками и с рандомными гранатами",
	clown2 = "Клоун - с драбашом и с стан дробошом",
	clown3 = "Клоун - с 3 клоунскими пушками",
	juggernaut1 = "Джагернаут - с огромной безумной батареей",
	juggernaut2 = "Джагернаут - с отрубателей голов секирой",
	captain1 = "Капитан - с двумя улучшенными револьверами",
	captain2 = "Капитан - с пиратской штурмовой винтовкой и ревиком",
	engineer1 = "Инженер - с разрядником и закаленным ломом",
	engineer2 = "Инженер - с ускорителем распадом",
	gunner1 = "Артелерист - с ручным гранатамётом",
	gunner2 = "Артелерист - с гранатамётом",
}
