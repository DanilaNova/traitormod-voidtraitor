...
event.Start = function()
    ...
    if character ~= nil and Traitormod.ApplyTemporarySkillBuff(character, { electrical = 100 }, 300) then
        Traitormod.SendMessageCharacter(character, Traitormod.Language.EngineerSkillBoost, "InfoFrameTabButton.Mission")
    end
