...
category.Identifier = "teamBlueDB"
...
category.Products = {
	{
		...
		Action = function(client)
			...
			Entity.Spawner.AddItemToSpawnQueue(helmet, client.Character.Inventory, nil, nil, function(item)
				item.set_InventoryIconColor(Color(0, 0, 200, 255))
				item.SpriteColor = Color(0, 0, 200, 255)
				item.Tags = "smallitem"
			...
			Entity.Spawner.AddItemToSpawnQueue(armor, client.Character.Inventory, nil, nil, function(item)
				...
				item.set_InventoryIconColor(Color(0, 0, 200, 255)) -- Цвет иконки в инвентаре
				item.SpriteColor = Color(0, 0, 200, 255) -- Цвет спрайта (предмета в игре)
				item.Tags = "smallitem"
